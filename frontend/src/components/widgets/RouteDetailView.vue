...
<template>
  <div class="h-full relative overflow-hidden">
    <!-- CASE 1: ACTIVE NAVIGATION MODE -->
    <WidgetContainer v-if="tripStore.currentTrip" padding="px-5 py-8 pb-32" space="space-y-0" class="!bg-slate-50/40">
    ...
    <WidgetContainer v-else-if="tripStore.pendingTrip" padding="px-6 py-8 pb-32" space="space-y-0" class="!bg-slate-50/30">
      <div class="mb-10">
      ...
      <template #footer>
        <BottomActionBar 
          ...
          @primary-click="handleConfirmTrip"
          @secondary-click="handleStartEdit"
        />
      </template>
    </WidgetContainer>

    <!-- CASE 3: EMPTY STATE -->
    <WidgetContainer v-else padding="p-8 pb-32" space="space-y-0" class="!bg-white">
