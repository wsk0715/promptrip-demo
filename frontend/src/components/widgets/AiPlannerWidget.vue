...
<template>
  <div class="h-full flex flex-col gap-5 p-4 overflow-y-auto custom-scrollbar">
    ...
    <div class="relative group">
      <textarea 
        ...
        placeholder="예: 해운대역 주변 힐링하기 좋은 조용한 카페 코스 짜줘"
    ...
    <!-- AI Agent Logs -->
    <div v-if="tripStore.logs.length > 0 || tripStore.isProcessing" class="bg-slate-900 text-slate-300 p-4 rounded-2xl font-mono text-xs shadow-inner relative overflow-hidden animate-in fade-in zoom-in duration-500">
