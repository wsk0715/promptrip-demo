...
<template>
  <WidgetContainer v-if="tripStore.pendingTrip" padding="px-6 py-8 pb-32" space="space-y-0" class="!bg-slate-50/30">
    <div class="mb-8">
    ...
    <template #footer>
      <template v-if="isEditing">
        <div class="absolute bottom-0 inset-x-0 bg-white/90 backdrop-blur-xl border-t border-slate-100 px-6 py-6 z-50 flex gap-3">
      ...
      <BottomActionBar 
        ...
        @primary-click="tripStore.confirmTrip()"
